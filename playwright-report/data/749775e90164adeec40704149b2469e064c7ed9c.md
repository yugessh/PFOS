...
- Name: workflows.spec.ts >> Workflow validations >> goal workflow passes
- Location: tests\e2e\workflows.spec.ts:17:7
...
Call log:
  - waiting for locator('text=Run Goal Workflow') to be visible
