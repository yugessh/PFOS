          ...
          <div className="space-y-2">
            ...
            <div className="grid grid-cols-2 gap-2">
              <div className="bg-green-50 dark:bg-green-900/20 rounded px-2 py-1.5">
                <p className="text-[10px] text-gray-600 dark:text-gray-400">Saved</p>
                <p className="text-xs font-bold text-green-600 dark:text-green-400">{formatCurrency(totalSaved)}</p>
              </div>
              <div className="bg-blue-50 dark:bg-blue-900/20 rounded px-2 py-1.5">
                <p className="text-[10px] text-gray-600 dark:text-gray-400">Target</p>
                <p className="text-xs font-bold text-blue-600 dark:text-blue-400">{formatCurrency(totalTarget)}</p>
              </div>
            </div>
          </div>
        )}
                  ...
                  <div className="mt-2 pt-2 border-t border-gray-200 dark:border-gray-800">
                    <div className="flex gap-2">
                      <input
                        ...
                        className="flex-1 px-2 py-1 text-xs rounded border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-800 text-gray-900 dark:text-white"
                      ...
                      <Button
                        ...
                        disabled={
                          ...
                          contributionAmounts[goal.id] > remaining
                        }
                        onClick={async () => {
                          const amount = contributionAmounts[goal.id] || 0;
                          if (amount <= 0 || amount > remaining) return;
                          await updateSavedAmount(goal.id, goal.savedAmount + amount);
                          setContributionAmounts((prev) => ({
                            ...prev,
                            [goal.id]: 0,
                          }));
        ...
        <SheetContent side="bottom" className="rounded-t-2xl">
          ...
          <div className="space-y-4">
            ...
            <Button
              ...
              disabled={saving || !formData.title || formData.targetAmount <= 0}
              className="w-full"
            >
