...
export const SUBCOLLECTIONS = {
  ...
  USER_SAVED_SEARCHES: (userId: string) => `${COLLECTIONS.USERS}/${userId}/${COLLECTIONS.SAVED_SEARCHES}`,
  USER_SEARCH_HISTORY: (userId: string) => `${COLLECTIONS.USERS}/${userId}/${COLLECTIONS.SEARCH_HISTORY}`,
  USER_COMMAND_USAGE: (userId: string) => `${COLLECTIONS.USERS}/${userId}/${COLLECTIONS.COMMAND_USAGE}`,
